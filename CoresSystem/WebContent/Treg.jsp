	...
	<form action="Treg" method="post">
		<table align="center" width="450" border="0">
			...
			<tr>
				...
				<td><input type="text" name="T_password"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="radio" name="T_sex" class="radioCheck"value="男"checked="checked">男 
					<input type="radio" name="T_sex"class="radioCheck"value="女">女</td>
			</tr>
			<tr>
