...
<h2>选择课程</h2>
		...
		<tr>
			...
			<td>
				 ...
				 <input type="button" value="选  择"onclick="location='Choose?id=<%=list.get(0).get(i) %>'">
			</td>
		</tr>
		<%}} %>
	...
	<h2>已选择课程</h2>
		...
		<%list=(List)session.getAttribute("he"); 
		  if(list!=null){			  
			  for(int i=0;i<list.get(0).size();i++){
				  %>
		<tr>
			...
			<td>
				 ...
				 <input type="button" value="删  除"onclick="location='Ydelet?id=<%=list.get(0).get(i) %>'">
			</td>
		</tr>
		<%}} %>
